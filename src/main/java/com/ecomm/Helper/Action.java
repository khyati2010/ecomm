...
public class Action extends Browser {
	...
	/**
	 * Take input from locator and after return element after traversing through
	 * whole locater excel
	 * 
	 * @param ArrayList
	 * @param String
	...
	/**
	 * returns element present in table format in html page identified with tag
	 * type and searcheable element
	 * 
	 * @param locator
	 * @param String
	 * @param String
